...
func TestMySQL_CreateTable_JunctionTable_HasAutoincrement(t *testing.T) {
	...
	// Junction tables use AddTable with standard resource columns and SHOULD get AUTO_INCREMENT
	if !strings.Contains(sql, "AUTO_INCREMENT") {
		t.Errorf("junction table should have AUTO_INCREMENT, got:\n%s", sql)
	}
}
