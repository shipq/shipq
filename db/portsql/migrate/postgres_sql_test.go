...
func TestPostgres_CreateTable_AutoincrementPK_Bigint(t *testing.T) {
	...
	// Should emit GENERATED BY DEFAULT AS IDENTITY for single bigint PK
	if !strings.Contains(sql, `"id" BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY`) {
		t.Errorf("expected BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, got:\n%s", sql)
	}
}

func TestPostgres_CreateTable_AutoincrementPK_Integer(t *testing.T) {
	tb := ddl.MakeEmptyTable("users")
	...
	// Should emit GENERATED BY DEFAULT AS IDENTITY for single integer PK
	if !strings.Contains(sql, `"id" INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY`) {
		t.Errorf("expected INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY, got:\n%s", sql)
	}
}

func TestPostgres_CreateTable_CompositePK_NoAutoincrement(t *testing.T) {
	...
	// Composite PK should NOT get identity
	if strings.Contains(sql, "GENERATED") || strings.Contains(sql, "IDENTITY") {
		t.Errorf("composite PK should not have GENERATED/IDENTITY, got:\n%s", sql)
	}
}

func TestPostgres_CreateTable_StringPK_NoAutoincrement(t *testing.T) {
	...
	// String PK should NOT get identity
	if strings.Contains(sql, "GENERATED") || strings.Contains(sql, "IDENTITY") {
		t.Errorf("string PK should not have GENERATED/IDENTITY, got:\n%s", sql)
	}
}

func TestPostgres_CreateTable_JunctionTable_HasAutoincrement(t *testing.T) {
	...
	// Junction tables use AddTable with standard resource columns and SHOULD get GENERATED/IDENTITY
	if !strings.Contains(sql, "GENERATED") && !strings.Contains(sql, "IDENTITY") {
		t.Errorf("junction table should have GENERATED/IDENTITY, got:\n%s", sql)
	}
}

func TestPostgres_CreateTable_AutoincrementPK_NoDefault(t *testing.T) {
	...
	// Should have identity but NO DEFAULT clause
