...
func TestPostgres_CreateTable_JunctionTable_NoAutoincrement(t *testing.T) {
	...
	// Junction table should NOT get identity even with single integer PK
	if strings.Contains(sql, "GENERATED") || strings.Contains(sql, "IDENTITY") {
		t.Errorf("junction table should not have GENERATED/IDENTITY, got:\n%s", sql)
	}
}
