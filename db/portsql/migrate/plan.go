...
// authTableNames contains tables that should NOT receive the automatic
// author_account_id column. This includes:
//   - Tables generated by `shipq auth` (accounts, organizations, etc.)
//   - Framework-managed LLM tables (llm_conversations, llm_messages) which
//     use their own nullable account_id column to support public channels
var authTableNames = map[string]bool{
	"accounts":           true,
	"organizations":      true,
	"organization_users": true,
	"sessions":           true,
	"llm_conversations":  true,
	"llm_messages":       true,
}
