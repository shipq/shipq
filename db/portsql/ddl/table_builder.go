...
// IsJunctionTable returns whether this table has been marked as a junction table.
func (tb *TableBuilder) IsJunctionTable() bool {
	return tb.table.IsJunctionTable
}
