...
func generateImports(buf *bytes.Buffer, handlerPkgs map[string]codegen.PackageAlias, modulePath string, handlers []codegen.SerializedHandlerInfo) {
...
func generateHandlerWrapper(buf *bytes.Buffer, h codegen.SerializedHandlerInfo, handlerPkgs map[string]codegen.PackageAlias) {
	wrapperName := handlerWrapperName(h)
