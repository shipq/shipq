...
func GenerateHTTPTestClient(cfg HTTPTestClientGenConfig) ([]byte, error) {
	...
	handlerPkgs := codegen.CollectHandlerPackages(cfg.Handlers)
...
func generateTestClientImports(buf *bytes.Buffer, handlerPkgs map[string]codegen.PackageAlias) {
...
func generateTestClientMethod(buf *bytes.Buffer, h codegen.SerializedHandlerInfo, handlerPkgs map[string]codegen.PackageAlias) {
