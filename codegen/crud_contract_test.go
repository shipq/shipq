...
func TestCRUDContract_TypeNames(t *testing.T) {
	tests := []struct {
		...
		// GetResultType tests
		{"GetResultType accounts", "accounts", CRUD.GetResultType, "GetAccountByPublicIDResult"},
		{"GetResultType users", "users", CRUD.GetResultType, "GetUserByPublicIDResult"},
		...
		{"UpdateParamsType accounts", "accounts", CRUD.UpdateParamsType, "UpdateAccountByPublicIDParams"},
		{"UpdateParamsType users", "users", CRUD.UpdateParamsType, "UpdateUserByPublicIDParams"},

		// UpdateResultType tests
		{"UpdateResultType accounts", "accounts", CRUD.UpdateResultType, "UpdateAccountByPublicIDResult"},
		{"UpdateResultType users", "users", CRUD.UpdateResultType, "UpdateUserByPublicIDResult"},
	}
...
func TestCRUDContract_CursorFuncs(t *testing.T) {
	tests := []struct {
		...
		{"EncodeCursorFunc accounts", "accounts", CRUD.EncodeCursorFunc, "EncodeListAccountsCursor"},
		{"EncodeCursorFunc users", "users", CRUD.EncodeCursorFunc, "EncodeListUsersCursor"},
		{"DecodeCursorFunc accounts", "accounts", CRUD.DecodeCursorFunc, "DecodeListAccountsCursor"},
		{"DecodeCursorFunc users", "users", CRUD.DecodeCursorFunc, "DecodeListUsersCursor"},
	}
