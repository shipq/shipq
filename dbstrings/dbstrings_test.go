...
func TestToPascalCase(t *testing.T) {
	tests := []struct {
		...
		// Identifiers starting with digits get "X" prefix
		{"_1foo", "X1foo"},
		{"_1f8lx877y3g", "X1f8lx877y3g"},
		{"123abc", "X123abc"},
		{"1", "X1"},
		// Leading underscore with letter is fine
		{"_abc", "Abc"},
		// All-underscore inputs produce "X" fallback
		{"_", "X"},
		{"__", "X"},
		{"___", "X"},
		// Consecutive/trailing underscores
		{"foo__bar", "FooBar"},
		{"foo_", "Foo"},
		{"_foo_", "Foo"},
	}
