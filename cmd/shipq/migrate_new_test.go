...
func createMigrationHelper(t *testing.T, tmpDir string, name string, columns []ColumnSpec) string {
	t.Helper()
	...
	fileName := GenerateMigrationFileName(timestamp, name)
...
func TestMigrateNew_CreatesFile(t *testing.T) {
	...
	filePath := createMigrationHelper(t, tmpDir, "users", []ColumnSpec{
...
func TestMigrateNew_CreatesDirectory(t *testing.T) {
	...
	// Create migration
	createMigrationHelper(t, tmpDir, "users", []ColumnSpec{})
...
func TestMigrateNew_WithReferences(t *testing.T) {
	...
	filePath := createMigrationHelper(t, tmpDir, "posts", []ColumnSpec{
...
func TestMigrateNew_EmptyMigration(t *testing.T) {
	...
	filePath := createMigrationHelper(t, tmpDir, "empty", []ColumnSpec{})
...
func TestMigrateNew_GeneratedCodeIsValidGo(t *testing.T) {
	...
	testCases := []struct {
		...
		{"empty", []ColumnSpec{}},
		{"simple", []ColumnSpec{{Name: "name", Type: "string"}}},
		{"multi_col", []ColumnSpec{
			{Name: "name", Type: "string"},
			{Name: "age", Type: "int"},
